...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "It's infrastructure. I build with it.", range: [6, 7] },
    ],
  },
  {
    ...
    options: [
      ...
      { label: 'I use it occasionally — npm installs, git, that kind of thing', range: [4, 5] },
      { label: "It's where I work. Claude Code runs there.", range: [6, 7] },
    ],
  },
  {
